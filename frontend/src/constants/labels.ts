...
const labelsByLanguage = {
  ar: {
    ...
    nav: {
      ...
      financeInvoices: "مساهمات الطلاب الاختيارية",
    ...
    auth: {
      ...
      backendUnavailable: "تعذر الاتصال بالخادم. تحقق من اتصال الإنترنت أو حاول مرة أخرى.",
  ...
  en: {
    ...
    nav: {
      ...
      financeInvoices: "Optional Student Contributions",
    ...
    auth: {
      ...
      backendUnavailable: "Unable to reach the server. Check your connection and try again.",
