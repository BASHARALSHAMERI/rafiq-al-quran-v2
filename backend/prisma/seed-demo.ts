...
async function cleanup() {
  console.log("⚠️ تم تعطيل cleanup() في seed-demo.ts لعدم مسح البيانات الأصلية.");
  // تم إيقاف عملية المسح الشامل لحماية قاعدة البيانات من أي حذف عرضي
}
...
async function main() {
  // ══════════════════════════════════════════════════════════════════
  // SAFETY RULE: هذا الملف لا يحذف أي بيانات تحت أي ظرف.
  // الـ seed يعمل فقط عند التثبيت الأول (قاعدة البيانات فارغة).
  // لإعادة الضبط الكاملة يجب تنفيذ: npx prisma migrate reset
  // ══════════════════════════════════════════════════════════════════

  // تخطي الفحص للسماح بزراعة البيانات الإضافية فوق النظام الحالي
  // قاعدة البيانات فارغة أو ممتلئة — سيتم المتابعة لزراعة بيانات العرض التجريبي
  console.log("🌱 جاري إعداد البيانات التجريبية...");
  await seed();
}
