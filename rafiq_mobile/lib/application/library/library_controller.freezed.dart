    ...
    return _then(_$LoadedImpl(
      categories: null == categories
          ...
          : categories // ignore: cast_nullable_to_non_nullable
              as List<LibraryCategoryDto>,
      items: null == items
          ? _value._items
          : items // ignore: cast_nullable_to_non_nullable
              as List<LibraryItemDto>,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {final List<LibraryCategoryDto> categories = const [],
      final List<LibraryItemDto> items = const [],
      this.categoriesError,
      this.itemsError})
      : _categories = categories,
        _items = items;

  final List<LibraryCategoryDto> _categories;
  @override
  @JsonKey()
  List<LibraryCategoryDto> get categories {
    if (_categories is EqualUnmodifiableListView) return _categories;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_categories);
  }

  final List<LibraryItemDto> _items;
  @override
  @JsonKey()
  List<LibraryItemDto> get items {
  ...
  @override
  String toString() {
    return 'LibraryState.loaded(categories: $categories, items: $items, categoriesError: $categoriesError, itemsError: $itemsError)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(categories, items, categoriesError, itemsError);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(categories, items, categoriesError, itemsError);
  }
...
abstract class _Loaded implements LibraryState {
  const factory _Loaded(
      ...
      final List<LibraryItemDto> items,
      final String? categoriesError,
      final String? itemsError}) = _$LoadedImpl;
